...
namespace VeterinarskaStanica.Services.Migrations
{
    ...
    [Migration("20230611081010_ZaposleniciRadnaMjesta")]
    partial class ZaposleniciRadnaMjesta
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeterinarskaStanica.Services.Database.ZaposleniciRadnaMjesta", b =>
                {
                    b.Property<int>("ZaposlenikRadnoMjestoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ZaposlenikRadnoMjestoID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ZaposlenikRadnoMjestoId"));
                    ...
                    b.HasKey("ZaposlenikRadnoMjestoId");

                    b.HasIndex("RadnoMjestoId");

                    b.HasIndex("ZaposlenikId");

                    b.ToTable("ZaposleniciRadnaMjesta", (string)null);
                });
            ...
            modelBuilder.Entity("VeterinarskaStanica.Services.Database.ZaposleniciRadnaMjesta", b =>
                {
                    b.HasOne("VeterinarskaStanica.Services.Database.RadnaMjesta", "RadnoMjesto")
                        .WithMany("ZaposleniciRadnaMjestas")
                        .HasForeignKey("RadnoMjestoId")
                        .IsRequired()
                        .HasConstraintName("FK_ZaposleniciRadnaMjesta_RadnoMjesto");

                    b.HasOne("VeterinarskaStanica.Services.Database.Zaposlenici", "Zaposlenik")
                        .WithMany("ZaposleniciRadnaMjestas")
            ...
            modelBuilder.Entity("VeterinarskaStanica.Services.Database.RadnaMjesta", b =>
                {
                    b.Navigation("ZaposleniciRadnaMjestas");
