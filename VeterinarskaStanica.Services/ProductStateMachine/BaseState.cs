...
namespace VeterinarskaStanica.Services.ProductStateMachine
{
	public class BaseState
	{
		...
		public BaseState(IServiceProvider serviceProvider, VeterinarskaStanicaContext context, IMapper mapper)
		{
			Context = context;
		...
		public VeterinarskaStanicaContext Context { get; set; } = null;
